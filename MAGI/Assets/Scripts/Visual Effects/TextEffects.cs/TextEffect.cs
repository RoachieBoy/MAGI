...
namespace Visual_Effects.TextEffects.cs
{
    ...
    {
        [Header("What effect do I have?")] [SerializeField]
        private TextEffects textEffectType;

        [Header("How do I move?")] [Range(0.5f, 10f)] [SerializeField]
        private float sinMovementSpeed = 4f;

        [Range(0.5f, 10f)] [SerializeField] private float sinWaveSpeed = 5f;
